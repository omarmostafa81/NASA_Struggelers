...
class B_catogaries_ar extends StatelessWidget {
  @override
                  ...
                  body: SingleChildScrollView(
                      child: Column(
                        children: <Widget> [
                            ...
                            children: [
                              Padding( padding: const EdgeInsets.fromLTRB(0, 50, 30, 20),
                                child: RaisedButton.icon(
                                  onPressed: (){
                                    Navigator.pushReplacementNamed(context, 'B-categories-en');
                                  },
                                  color: Colors.blue,
                                  icon: Icon (
                                    Icons.translate,
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-overview-ar');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-divisions-ar');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-missions-ar');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-choosecoll-ar');
                            },
                            child: Text(
                              'تعاونات ناسا',
                              style: TextStyle(
