...
class B_missions_en extends StatelessWidget {
  @override
                  ...
                  body: SingleChildScrollView(
                      child: Column(
                        children: <Widget> [
                            ...
                            children: [
                              Padding( padding: const EdgeInsets.fromLTRB(30, 50, 0, 20),
                                child: RaisedButton.icon(
                                  onPressed: (){
                                    Navigator.pushReplacementNamed(context, 'B-missions-ar');
                                  },
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-first-en');
                            },
                            child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-second-en');
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-third-en');
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-four-en');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-five-en');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-six-en');
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-seven-en');
                              },
                              child: Text(
                                'ACT-America',
                                style: TextStyle(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-eight-en');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-nine-en');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-ten-en');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-eleven-en');
