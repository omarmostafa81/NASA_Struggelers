...
class B_missions_ar extends StatelessWidget {
  @override
                  ...
                  body: SingleChildScrollView(
                      child: Column(
                        children: <Widget> [
                            ...
                            children: [
                              Padding( padding: const EdgeInsets.fromLTRB(0, 50, 30, 20),
                                child: RaisedButton.icon(
                                  onPressed: (){
                                    Navigator.pushReplacementNamed(context, 'B-missions-en');
                                  },
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-first-ar');
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-second-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-third-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-four-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-five-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-six-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-seven-ar');
                              },
                              child: Text(
                                'ACT- أمريكا',
                                style: TextStyle(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-eight-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-nine-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-ten-ar');
                              },
                              child: Text(
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: (){
                                Navigator.pushNamed(context, 'B-eleven-ar');
                              },
                              child: Text(
                                'برنامج اطلس',
                                style: TextStyle(
