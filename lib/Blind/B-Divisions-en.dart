...
class B_Divisions_en extends StatelessWidget {
  @override
                  ...
                  body: SingleChildScrollView(
                      child: Column(
                        children: <Widget> [
                            ...
                            children: [
                              Padding( padding: const EdgeInsets.fromLTRB(30, 50, 0, 20),
                                child: RaisedButton.icon(
                                  onPressed: (){
                                    Navigator.pushReplacementNamed(context, 'B-Divisions-ar');
                                  },
                                  color: Colors.blue,
                                  icon: Icon (
                                    Icons.translate,
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-flight-en');
                            },
                            child: Text(
                              'Flight Division',
                              style: TextStyle(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-appliedscience-en');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-research-en');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-techoffice-en');
                            },
                            child: Text(
