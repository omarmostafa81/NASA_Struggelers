...
class B_choosecoll_ar extends StatelessWidget {
  @override
                  ...
                  body: SingleChildScrollView(
                      child: Column(
                        children: <Widget> [
                            ...
                            children: [
                              Padding( padding: const EdgeInsets.fromLTRB(0, 50, 30, 20),
                                child: RaisedButton.icon(
                                  onPressed: (){
                                    Navigator.pushReplacementNamed(context, 'B-choosecoll-en');
                                  },
                                  color: Colors.blue,
                                  icon: Icon (
                                    Icons.translate,
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll1-ar');
                            },
                            child: Text(
                              'مختبر الدفع النفاث',
                              style: TextStyle(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll2-ar');
                            },
                            child: Text(
                              'مركز مارشال للأبحاث',
                              style: TextStyle(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll3-ar');
                            },
                            child: Text(
                              ' مركز جونسون للفضاء',
                              style: TextStyle(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll4-ar');
                            },
                            child: Text(
                              'مركز كنيدي للفضاء',
                              style: TextStyle(
