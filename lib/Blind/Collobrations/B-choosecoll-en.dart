...
class B_choosecoll_en extends StatelessWidget {
  @override
                  ...
                  body: SingleChildScrollView(
                      child: Column(
                        children: <Widget> [
                            ...
                            children: [
                              Padding( padding: const EdgeInsets.fromLTRB(30, 50, 0, 20),
                                child: RaisedButton.icon(
                                  onPressed: (){
                                    Navigator.pushReplacementNamed(context, 'B-choosecoll-ar');
                                  },
                                  color: Colors.blue,
                                  icon: Icon (
                                    Icons.translate,
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll1-en');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll2-en');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll3-en');
                            },
                            child: Text(
                          ...
                          RaisedButton(
                            onPressed: (){
                              Navigator.pushNamed(context, 'B-coll4-en');
                            },
                            child: Text(
