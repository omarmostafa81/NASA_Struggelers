...
class N_categories_en extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          ...
          Container(
            ...
            children: <Widget> [
                ...
                children: [
                  Padding( padding: const EdgeInsets.fromLTRB(30, 50, 0, 20),
                    child: RaisedButton.icon(
                      onPressed: (){
                        Navigator.pushReplacementNamed(context, 'N-categories-ar');
                      },
                      color: Colors.blue,
                      icon: Icon (
                        Icons.translate,
              ...
              RaisedButton(
                onPressed: (){
                  Navigator.pushNamed(context, 'N-overview-en');
                },
                child: Text(
              ...
              RaisedButton(
                onPressed: (){
                  Navigator.pushNamed(context, 'N-Divisions-en');
                },
                child: Text(
              ...
              RaisedButton(
                onPressed: (){
                  Navigator.pushNamed(context, 'N-missions-en');
                },
                child: Text(
              ...
              RaisedButton(
                onPressed: (){
                  Navigator.pushNamed(context, 'N-choosecoll-en');
                },
                child: Text(
                  'NASA Collaborations',
                  style: TextStyle(
